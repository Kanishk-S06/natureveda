    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen bg-custom-1">
          <div className="bg-white p-6 rounded-lg shadow-md w-96">
            ...
            <div className="mb-4">
              <label htmlFor="name" className="block text-gray-700 font-nunito-sans">Name</label>
              <input
                type="text"
                id="name"
                name="name"
            ...
            <div className="mb-4">
              <label htmlFor="email" className="block text-gray-700 font-nunito-sans">Email</label>
              <input
                type="email"
                id="email"
                name="email"
            ...
            <div className="mb-4">
              <label htmlFor="query" className="block text-gray-700 font-nunito-sans">Query</label>
              <textarea
                id="query"
                name="query"
                rows="4"
